...
L["Search"] = "Поиск"
L["Collectables in this zone"] = "Собранные в этой зоне"
L["Companions in"] = "Питомцы в"

-- Отсутствующие в UI
L["Toys"] = "Игрушки"
L["Heirlooms"] = "Наследство"
...
L["Quality Check"] = "Проверка качества"
L["Missing Check"] = "Проверка отсутствия"
L["Perform check in pet battles if enemy pets are missing in your collection"] = "Проведите проверку в битвах питомцев, если в вашей коллекции отсутствуют вражеские питомцы"
L["Level Check"] = "Проверка уровня"
L["Perform level check in pet battles if enemy pets have a higher level"] = "Выполняйте проверку уровня в битвах с питомцами, если у вражеских питомцев более высокий уровень"
L["Macros"] = "Макрос"
L["Pet Battles"] = "Боевые питомцы"
L["Profiles"] = "Профили"
L["Collected companions"] = "Собранные питомцы"
L["Display already collected companions"] = "Показывать уже собранных питомцев"
L["Missing companions"] = "Отсутствующие питомцы"
L["Display missing companions"] = "Показать отсутствующих питомцев"
L["Companion Quality"] = "Качество питомцев"
L["Display companion quality"] = "Показывать качесто питомцев"
L["Collected mounts"] = "Собранный транспорт"
L["Display already collected mounts"] = "Показать уже собранный транспорт"
L["Missing mounts"] = "Отсутствующий транспорт"
L["Display missing mounts"] = "Показывать отсутствующий транспорт"
L["Collected toys"] = "Собранные игрушки"
L["Display already collected toys"] = "Показывать уже собранные игрушки"
L["Missing toys"] = "Отсутствующие игрушки"
L["Display missing toys"] = "Показать отсутствующие игрушки"
L["Collected followers"] = "Собранные соратники"
L["Display already collected followers"] = "Показать уже собранных соратников"
L["Missing followers"] = "Отсутствующие соратники"
L["Display missing followers"] = "Показывать отсутствующих соратников"
...
L["Left Click on Mount Macro"] = "Левый клик на транспорт макрос"
L["Right Click on Mount Macro"] = "Правый клик на транспорт макрос"
L["Shift + Left Click on Mount Macro"] = "Shift + Левый клик на транспорт макрос"
...
L["title_148"] = "Награда за нахождение одного редкого артефакта в археологии"
L["title_149"] = "Награда за нахождение 10 редкого артефакта в археологии"
L["title_188"] = "Награда за превознесение у 'Хиджальских Мстителей'"
